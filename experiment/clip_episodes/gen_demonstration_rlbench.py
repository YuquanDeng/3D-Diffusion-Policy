...
def main(args):
    ...
    save_dir = os.path.join(args.save_dir, args.save_filename)
    ...
    while episode_idx < num_episodes:        
        ...
        # NOTE: 
        # (1) for slide_block_to_color_target variation 2, the episode length
        # is always 96.
        # (2) for clip_episodes experiment, we only use frame between [0, 70).
        ...
        # for idx in range(len(demo)):
            ...
            if use_point_crop:
                ...
                point_cloud = point_cloud[mask]
            point_cloud = point_cloud_sampling(point_cloud, num_points, 'fps') # (num_points, 3) or (num_points, 6)
            ...
            obs_dict = {
                "image": obs.front_rgb.astype("float32") / 255.0,
            ...
            if args.rot_representation == "quat":
                ...
                # print("prev_robot_state: ", prev_robot_state)
                # print("obs_robot_state: ", obs_robot_state)
                # import pdb; pdb.set_trace()
        ...
        if args.rot_representation == "quat":
            ...
            action_arrays_sub[-1][6] = 1 # x, y, z, qx, qy, qz, qw, gripper => quaternion with qw=1 means no rotation.
        elif args.rot_representation == "euler":
        ...
        cprint('Episode: {}'.format(episode_idx, ep_reward, ep_success_times), 'green')
        episode_idx += 1
...
if __name__ == "__main__":
    ...
    arg.add_arg('save_filename', 'default.zarr', 'output dataset directory name')
    arg.parser()
