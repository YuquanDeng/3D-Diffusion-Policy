...
cd 3D-Diffusion-Policy/diffusion_policy_3d/RLBench
...
python gen_demonstration_rlbench_delta_action.py --env_name=${task_name} \
            --num_episodes 100 \
            --root_dir "/home/nil/manipulation/RVT2/rvt/data/128_1_var" \
            --save_dir "/home/nil/manipulation/3D-Diffusion-Policy/experiment/overfit_rlbench" \
            --use_point_crop True \
            --num_points 1024 \
